...
// CAMERA
const CAMERA_FOLLOW_MODES = { CHARACTER: 0, CURSOR: 1, CURSOR_EDGE: 2, DRAG_TO_PAN: 3, LOCKED: 4, OVERVIEW: 5, LEASH: 6, CINEMATIC: 7 };
...
class Utility {
    ...
    ********************************************/
	...
	static ignoreElementsSelector = 'body, html, .ignore, .particle, .interactableObject, .interactive-myte, .myte, button, .myte-slot, .app-shell, .app-stage, #controls, .canvas, .canvas > .layer, #inventory';
